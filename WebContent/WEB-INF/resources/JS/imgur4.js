...
(function (root, factory) {
    ...
    var Imgur = function (options) {
        ...
        this.dropzone = document.querySelectorAll('.dropzone4');
        this.info = document.querySelectorAll('.info4');
    ...
    Imgur.prototype = {
        ...
        status: function (el) {
            var div = this.createEls('div', {className: 'status4'});

            this.insertAfter(el, div);
        },
        matchFiles: function (file, zone) {
            var status4 = zone.nextSibling;

            if (file.type.match(/image/) && file.type !== 'image/svg+xml') {
                document.body.classList.add('loading');
                status4.classList.remove('bg-success', 'bg-danger');
                status4.innerHTML = '';
                ...
                status4.classList.remove('bg-success');
                status4.classList.add('bg-danger');
                status4.innerHTML = 'Invalid archive';
            }
        },
