(function (root, factory) {
    ...
    var Imgur = function (options) {
        ...
        this.dropzone = document.querySelectorAll('.dropzone5');
        this.info = document.querySelectorAll('.info5');
    ...
    Imgur.prototype = {
        ...
        status: function (el) {
            var div = this.createEls('div', {className: 'status5'});

            this.insertAfter(el, div);
        },
        matchFiles: function (file, zone) {
            var status5 = zone.nextSibling;

            if (file.type.match(/image/) && file.type !== 'image/svg+xml') {
                document.body.classList.add('loading');
                status5.classList.remove('bg-success', 'bg-danger');
                status5.innerHTML = '';
                ...
                status5.classList.remove('bg-success');
                status5.classList.add('bg-danger');
                status5.innerHTML = 'Invalid archive';
            }
        },
