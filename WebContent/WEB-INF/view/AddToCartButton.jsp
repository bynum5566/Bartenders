          ...
          <li class="special">
            ...
            <div id="menu">
              <ul>
                ...
                <li class="small"><a href="/Bartenders/Welcome./Bartenders/Welcome.UserFirstPage">首頁</a><a href="javascript:signOut()">登出</a></li>
              </ul>
            </div>
          </li>
        </ul>
							...
							<div>
								...
								<div class="row gtr-uniform">
									<div class="col-6 col-12-xsmall">
										...
										<br>
										<Input class="button primary" type='submit' value='加入購物車'>
										</form>
									</div>
								</div>
							</div>
