...
<body>
	...
	<main>
		<div align="center">
			<h3 style="color: WhiteSmoke;">使用者重設密碼</h3>
			<form action="<c:url value="/resetPassword.controller" />"
				method="post">
				<table>
					<tr>
						<td>帳號:</td>
					...
					<tr>
						<td>EMAIL帳號:</td>
						<td><input type="email" name="useremail" autocomplete="off"
					...
					<tr>
						<td>手機:</td>
						<td><input type="text" name="userphone" autocomplete="off"
							size="50" placeholder="請填寫正確的手機號碼" required="required" /><br></td>
						<td>${errors.phone}</td>
					</tr>
					<tr>
						<td>密碼:</td>
