						...
						<div class="row">
							<div class="col-6 col-12-medium">
									...
									<form>
										<ul class="actions">
											<li>
												<a class="button" href="<c:url value="/DisplayProductList.controller"/>?barAccount=${barAccount}">回到酒吧</a>
											</li>
											<li>
												<a class="button" href="<c:url value="/DisplayCartList.controller"/>">回到購物車 </a>
											</li>
										</ul>
									</form>
								</div>
