...
<body>
	<div class="outwrap">
		<div class="inwrap">
			<h1>新增票券</h1>
			<form action="<c:url value=" /addTkPD">
				</c:url>" method="POST"
				...
				<table>
					...
					<tr>
						...
						<td><input class="bt0" name="pdStk" id="pdamount" type="number" min="1" required="required">
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input name="setTKTime" id="setB1" class="dateRange2 form-control" type="text"
					...
					<tr>
						<td colspan="2" id="bT">
							<!-- <a href="/Bartenders/Dashboard.TkProducts">
								<input class="bt01 bt0 bT" type="button" value="回票券商品管理"/>
							</a> -->
							<button onclick="location.href = '/Bartenders/Dashboard.TkProducts';"
								class="bT">回上頁</button>
							<!-- <a href="/Bartenders/TicketProduct.Add">
								<input class="bt01 bt0 bT" type="button" value="重填"/></a> -->
