...
<body>
	<div class="outwrap">
		<div>
			<h1>新增商品</h1>
			<form action="<c:url value="/addTkPD"></c:url>" method="POST"
				...
				<table>
					...
					<tr>
						<td class="lb setT2"><label>票券有效期間:</label></td>
						<td><input name="setTKTime" id="setB1"
							class="dateRange2 form-control" type="text" required="required"/></td>
					</tr>						
					<tr>
					...
					<tr>
						<td class="bt01 bt0" colspan="2"><a href="/Bartenders/Dashboard.TkProducts">
							...
							<input class="bt01 bt0" type="submit" value="新增商品" />
						</td>
					</tr>
				</table>
			</form>
