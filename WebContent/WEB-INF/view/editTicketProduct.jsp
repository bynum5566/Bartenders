								...
								<form action="<c:url value="/editTkPD"></c:url>" method="POST" enctype="multipart/form-data">
									<div class="row gtr-uniform">
										<div class="col-6 col-12-xsmall">
											<ul id="hdId">
												<li colspan="2"><input class="bt0" name="pdId" type="text" required="required" value="<c:out value="${pdId}"/>" readonly="readonly"></li>
											</ul>
											<ul>
												<li>
													<h3>商品名稱</h3>
											...
											<ul class="actions">
												<li id="bT">
													<a href="/Bartenders/Dashboard.TkProducts">
														<div class="button">回票券商品管理</div>
													</a></li>
												<li><input class="button primary" type="submit" value="修改商品"/></li>
											</ul>
										</div>
									</div>
								</form>
