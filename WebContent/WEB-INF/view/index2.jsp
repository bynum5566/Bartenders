        ...
        <form>
          <div class="form-group row">
            ...
            <div class="col-10 input_bgg">
              <input type="id" class="form-control-plaintext input_bg" id="inputPassword" placeholder="請輸入帳號">
            </div>
          </div>
          <div class="form-group row">
            ...
            <div class="col-10">
              <input type="password" class="form-control-plaintext input_bg" id="inputPassword" placeholder="請輸入密碼">
            </div>
          </div>
        </form>
...
<div class="col-sm-7 dis480">
    ...
    <button class="text-center loginBtn loginBtn--google">
      Google
    </button>
</div>
              ...
              <button type="button" class="btn btn-dark ">送出</button>
               ...
               <div class="display480">
                ...
                <div class="col-12  p-0 mt-1">                  <button class="text-center col-12 loginBtn loginBtn--google">
                  Google &nbsp;
                </button></div>
