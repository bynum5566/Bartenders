	...
	<section class="container">
		<div class="float_center">
			<c:forEach var="Activity" items="${activity}" varStatus="status">
				<div class="each" id="each${Activity.activityId}">
					<fieldset style="width: 350px;border-radius:30px">
						...
						<p align=left style="margin: 10px">${Activity.address} <button id="${Activity.activityId}Bhidden${status.index+1}" class="closeAndOpen" type="button">確認地圖</button></p>
						...
						<span>
							<button
								id="single${Activity.activityId}" class="singlePage">進入活動頁面</button>
							<button
