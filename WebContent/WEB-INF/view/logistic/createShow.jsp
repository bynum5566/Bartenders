							...
							<form action="saveActivity.do" method="post" enctype="multipart/form-data">
								<fieldset style="width: 500px">
									...
									<p id="ip" align="right"
										...
										<input type="radio" id="party" name="type" value="party"><label
											for="party">派對</label>
										<input type="radio" id="show" name="type" value="show"> <label
											for="show">酒展</label>
									...
									<p style="margin: 5px"><input id="beginTime" type="text" name="beginTime"
											placeholder="請選擇開始時間"> ~ <input id="endTime" type="text" name="endTime"
											placeholder="結束時間"></p>
									<p style="margin: 5px"><input type="text" name="address" placeholder="活動地址"
											style="width:350px"></p>
									<p style="margin: 5px"><input type="text" name="targetNum" placeholder="參加人數上限"
											style="width:100px"> /
									...
									<p>地圖位置: <button id="Bhidden" type="button">確認地圖</button><img id="smallok"
											src="images/ok.jpg" style="visibility:collapse"><input id="lat"
