		...
		<form action="updateActivity.do" method="post" enctype="multipart/form-data">
			<fieldset style="width: 500px">
				...
				<c:forEach var="Activity" items="${activity}" varStatus="status">
					...
					<input type="radio" id="party" name="type" value="party" check=""><label for="party">派對</label> 
					<input type="radio" id="show" name="type" value="show" check=""> <label for="show">酒展</label></p>
					
					<p style="margin: 5px"><input id="beginTime" type="text" name="beginTime"
							value="${Activity.beginTime}"> ~ <input
							id="endTime" type="text" name="endTime"
							value="${Activity.endTime}"></p>
					<p style="margin: 5px"><input type="text" name="address" value="${Activity.address}" style="width:350px"></p>
					<p>參加人數上限:
					<input type="text" name="targetNum" style="width:100px" value="${Activity.targetNum}" > /內建人數:
					<input type="text" name="actualNum"  style="width:100px" value="${Activity.actualNum}">
					</p>
					<p>地圖位置: <button id="Bhidden" type="button">確認地圖</button><img id="smallok" src="images/ok.jpg" style="visibility:collapse">
					...
					<p><input type="text" value="${Activity.brief}" style="width:400px;height:250px" name="brief"></p>
