...
<%-- 本體，開始 --%>
		...
		<h2>${num}</h2>
		<form>
			<!-- 	<a href="<c:url value="/ChangeNumberOfProductInCart.controller"/>">返回購物車清單 </a>  -->

			<a href="<c:url value="/ChangeNumberOfProductInCart.controller"/>?num=${num}">返回購物車清單 </a> </h2> </form>
