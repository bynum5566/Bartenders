...
@MultipartConfig
@WebServlet(urlPatterns = { "/JavaMailController" }, initParams = {
		@WebInitParam(name = "host", value = "smtp.gmail.com"), @WebInitParam(name = "port", value = "587"),
		@WebInitParam(name = "username", value = "11129henry@gmail.com"),
		@WebInitParam(name = "password", value = "PassW0rd@aryido") })
public class JavaMailController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			response.sendRedirect("http://localhost:8080/Bartenders/VerifyMailPage");
		} catch (Exception e) {
