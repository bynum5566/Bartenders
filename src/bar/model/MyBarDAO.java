...
public class MyBarDAO {
	...
	public void updateBar(String logoUrl,String coverUrl1,String coverUrl2,String coverUrl3,String coverUrl4,String coverUrl5, String aboutBar, String barFb, String barLine, String barIg, int companyId) {
		Session session = sessionFactory.getCurrentSession();
		String hqlStr = "update MyBar set logoUrl=:lUrl, coverUrl1=:cUrl1, coverUrl2=:cUrl2, coverUrl3=:cUrl3, coverUrl4=:cUrl4, coverUrl5=:cUrl5, aboutBar=:aBar, barFb=:bFb, barLine=:bLine, barIg=:bIg where companyId=:cId";
		Query query = session.createQuery(hqlStr);
